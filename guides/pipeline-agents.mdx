...
- The Ankra CLI installed in the job (`bash <(curl -sL https://github.com/ankraio/ankra-cli/releases/latest/download/install.sh)` or the [direct download](/integrations/ankra-cli)).
