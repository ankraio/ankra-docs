...
- **DOKS** - [DigitalOcean API token](/integrations/credentials) with read/write
...
- **AKS** - [Azure service principal](/integrations/credentials) with **Contributor** on the target subscription
