...
An **Azure service principal** stored in Ankra with **Contributor** on the target subscription. See [Azure Credentials](/integrations/credentials#azure-credentials).
...
- [Azure Credentials](/integrations/credentials#azure-credentials)
