...
<Note>
DigitalOcean bills the VPC NAT gateway separately (from $40/month per gateway). See [DigitalOcean's VPC NAT gateway pricing](https://www.digitalocean.com/pricing/networking) for current rates.
</Note>
