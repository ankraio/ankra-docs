...
An **UpCloud API credential** (API access for an UpCloud subaccount), stored in Ankra. See [UpCloud API Credentials](/integrations/credentials#upcloud-api-credentials).
...
- [UpCloud API Credentials](/integrations/credentials#upcloud-api-credentials)
