...
<Frame caption="Building a Monitoring Stack on Ankra">
  <video
    ...
    src="https://fsn1.your-objectstorage.com/ankra-vod/docs/ai-monitoring-stack.mp4"
  ></video>
</Frame>
...
Loki is a log aggregation system designed to work with Grafana. It's lightweight because it only indexes metadata, not the full log content.
