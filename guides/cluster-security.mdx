...
Server-paginated inventory with status tabs (**Open**, **Acknowledged**, **Accepted risk**, **Resolved**), filters for severity, fixability, cluster, add-on, and namespace, plus a detail sheet with occurrences and disposition actions.
...
- Quiet scanner/freshness status with refresh and secondary actions (schedule report, create alert).
