...
A **DigitalOcean API token** with read/write, stored in Ankra. See [DigitalOcean API Credentials](/integrations/credentials/digitalocean).
...
- [DigitalOcean API Credentials](/integrations/credentials/digitalocean)
