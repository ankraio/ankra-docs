...
A **DigitalOcean API token** with read/write, stored in Ankra. See [DigitalOcean API Credentials](/integrations/credentials#digitalocean-api-credentials).
...
- [DigitalOcean API Credentials](/integrations/credentials#digitalocean-api-credentials)
