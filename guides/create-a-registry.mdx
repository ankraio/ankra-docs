...
<Steps>
  <Step title="Create a registry credential">
    Go to **Credentials** → **Add** → **Registry** and enter your GitHub username and the Personal Access Token (with `read:packages` scope). See [Credentials](/integrations/credentials/registry) for details.
  </Step>
