...
An **AWS credential** stored in Ankra (access keys or an IAM role) with permissions for **EKS**, **EC2**, and **IAM role management**. See [AWS Credentials](/integrations/credentials#aws-credentials).
...
- [AWS Credentials](/integrations/credentials#aws-credentials)
