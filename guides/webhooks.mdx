...
<Steps>
  ...
  <Step title="Pick the home channel">
    Open **Organisation Settings → AI → Workspaces**, find **Ankra's home**, choose a Slack channel, and save.
  </Step>
</Steps>
...
| `{{severity_color}}` | Hex colour for severity | "#FF0000" |
...
| `{{trigger_url}}` | Direct link to the trigger detail page (acknowledge/snooze) |
