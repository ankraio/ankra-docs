...
**OVHcloud application keys** with a Public Cloud project (`project_id`), stored in Ankra. See [OVH API Credentials](/integrations/credentials/ovh).
...
- [OVH API Credentials](/integrations/credentials/ovh)
