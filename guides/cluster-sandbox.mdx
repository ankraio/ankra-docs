...
| **Resource budget**   | 3 vCPU / 4 GiB memory, of which roughly 1 GiB is yours - the virtual cluster's control plane, CoreDNS, the Ankra agent, Traefik, cert-manager and the starter app use the rest. Capped pods and storage |
