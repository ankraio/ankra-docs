...
<Warning>
The playground replaces the old read-only sandbox. If your organisation still sees a read-only "sandbox-demo" cluster, the playground has not been enabled for it yet - everything below applies once it is.
</Warning>
