...
| **Resource budget**   | 4 vCPU / 3 GiB memory, of which ~1.8 GiB is yours - the virtual cluster's own control plane uses the rest. Capped pods and storage. Plenty for exploring |
