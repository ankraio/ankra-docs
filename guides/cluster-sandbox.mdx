...
| **Resource budget**   | 2 vCPU / 3 GiB memory, of which roughly 800m CPU and 1.1 GiB is yours - the virtual cluster's control plane, the Ankra agent and the starter app use the rest. Capped pods and storage |
