...
- An Ankra account with access to your organisation's alerts
...
After authorization, copy your webhook URL. It will look like:
...
<Note>
Leave all clusters unchecked to monitor manifests across your entire organisation.
</Note>
...
8. **AI Incident generated** - Ankra's AI analyzes the data and produces:
...
- [Alerts](/guides/alerts) - Full alert rule configuration reference
- [Webhooks](/guides/webhooks) - Template variables and custom payloads
- [AI Incidents](/platform/ai-incidents) - Automatic root cause analysis
- [Operations](/platform/operations) - View job history and logs
