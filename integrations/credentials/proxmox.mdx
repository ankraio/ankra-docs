...
For Proxmox clusters you also need an [SSH key credential](/integrations/credentials/ssh-key) - create one with `ankra credentials proxmox ssh-key create --name my-key --generate`.
