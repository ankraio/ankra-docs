...
For self-managed UpCloud clusters you also need an [SSH key credential](/integrations/credentials/ssh-key) - create one with `ankra credentials upcloud ssh-key create --name my-key --generate`.
