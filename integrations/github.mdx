...
| Switch | What it does |
| --- | --- |
| **AI review** | Reviews every opened or updated pull request and posts the findings as a comment on it. |
...
<Steps>
  ...
  <Step title="Choose the installation-wide switches">
    Turn on **AI review**, **Mention replies**, and **PR previews** as needed. They apply to every repository the installation covers.
  </Step>
...
- The reply failed on Ankra's side, for example because the AI provider did not answer. Nothing is posted in that case; mention `@ankraai` again to retry.
