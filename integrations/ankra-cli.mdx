...
- Organisation management (list, switch, create, invite members)
- Cluster management (list, select, reconcile, provision, deprovision, delete, clone)
- Stack management (create, list, rename, delete, clone between clusters)
- Addon management (list, settings, update, uninstall)
- Operations management (list, cancel, inspect jobs)
- Agent management (status, token, upgrade)
...
ankra tokens create my-temp-token --expires "2025-12-31T00:00:00Z"
```
