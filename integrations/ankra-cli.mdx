...
#### cluster upgrade
Upgrade the Kubernetes (k3s) version on all nodes of a cloud cluster. Only Hetzner, OVH, UpCloud, DigitalOcean, Proxmox VE, and Morpheus clusters can be upgraded.
