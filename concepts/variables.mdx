...
Both scopes expose the same list/create/update/delete shape (bearer-token authenticated):

| Method | Path | Purpose |
|--------|------|---------|
| `GET` | `/api/v1/org/variables` | List organisation variables |
| `POST` | `/api/v1/org/variables` | Create an organisation variable |
| `PUT` | `/api/v1/org/variables/{variable_name}` | Update an organisation variable |
| `DELETE` | `/api/v1/org/variables/{variable_name}` | Delete an organisation variable |
| `GET` | `/api/v1/org/clusters/imported/{cluster_id}/variables` | List cluster variables |
| `POST` | `/api/v1/org/clusters/imported/{cluster_id}/variables` | Create a cluster variable |
| `PUT` | `/api/v1/org/clusters/imported/{cluster_id}/variables/{variable_name}` | Update a cluster variable |
| `DELETE` | `/api/v1/org/clusters/imported/{cluster_id}/variables/{variable_name}` | Delete a cluster variable |
