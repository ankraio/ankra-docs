...
[Learn more about Helm Registries →](/guides/registries)
...
Want to upload your own add-on? Add your registry to the Ankra Platform. Read more in [Registries](/guides/registries).
...
<Tip>
**Use variables**: Define configuration values as [Variables](/concepts/variables) rather than hardcoding them in Helm values.
</Tip>

<Tip>
**Enable SOPS for secrets**: Use [SOPS encryption](/guides/sops) for sensitive add-on values like passwords and API keys.
</Tip>
