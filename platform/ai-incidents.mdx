...
| **Analyzing** | AI processing data | Ankra's AI identifying root cause and patterns |
...
During the **Analyzing** phase, Ankra's AI:
...
- [Alerts](/guides/alerts) - Configure alert rules that generate AI incidents
- [AI Assistant](/platform/ai-assistant) - Learn more about Ankra's AI capabilities
