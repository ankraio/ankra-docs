...
Ankra's AI analyzes the collected data to:
...
This shows all automatically generated analyses with root cause, affected resources, and recommended actions. [Learn more about AI Incidents](/platform/ai-incidents).
...
- [AI Assistant](/platform/ai-assistant) - General AI capabilities in Ankra
- [AI Incidents](/platform/ai-incidents) - AI-powered alert analysis
- [Kubernetes Insights](/platform/kubernetes-insights) - Resource monitoring overview
- [Command Palette](/platform/command-palette) - Quick access to AI and navigation

---

Need help? [Join our Slack community](https://join.slack.com/t/ankra-community/shared_invite/zt-3a5rem8f8-cUho4epX2MoLT83bFf~VSA) for support.
