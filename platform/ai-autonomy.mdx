...
The ticket desk auto-files board tickets from proactive insights. Pick which severities create tickets and where ticket notifications go (a Slack channel or Teams conversation). See the AI board for how filed tickets are worked.
