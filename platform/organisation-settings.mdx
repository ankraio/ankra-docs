...
Ingress hostnames on your own domains therefore need records you publish yourself. This also delays cert-manager: an HTTP-01 challenge is answered over the hostname being certified, so no certificate is issued for a name that does not resolve yet.
</Note>

The CLI carries the same three operations:
