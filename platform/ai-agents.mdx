...
Watch a stack deployed and its upgrades handed to an agent, with the risky change parked for a human to approve.

<YouTube id="dspH7l5YO54" title="Deploy a stack and hand its upgrades to an AI agent - Ankra" />
