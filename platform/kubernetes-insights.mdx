...
- **Terminal** - an in-browser shell into any container, recorded to the audit log. See [Pod Terminal](/platform/pod-terminal).
- **Debug** - a pod that impersonates this one under an image with the tools you need. See [Debug Pods](/platform/debug-pods).
