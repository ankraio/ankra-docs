...
- **LoadBalancer Services on a meshed UpCloud cluster** — see the [UpCloud guide](/guides/upcloud-clusters): the provider's load balancers attach to the private network, not the overlay.
