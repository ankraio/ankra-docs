...
<Note>
With Ankra, you can define your entire cluster—configuration, manifests, and add-ons—in a single YAML file. This makes it easy to automate deployments, trigger changes from CI/CD, and reproduce environments on demand.
</Note>
...
- ⚡️ Quickly spin up or tear down clusters for testing, demos, or development.
...
> **Note:** If your project grows or you need more modularity, you can always switch to the multiple YAML (include paths) approach later.
