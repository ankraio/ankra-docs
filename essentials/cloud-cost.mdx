...
It returns estimated monthly cost, month-to-date, and projected month-end totals - in your configured display currency - both overall, per provider, and for the top clusters. This is the same rollup shown on the [Dashboard](/essentials/dashboard).
...
<Steps>
  ...
  <Step title="Bring the cluster online">
    Ensure the [agent](/essentials/cluster-agent) is connected so node and volume inventory can sync.
  </Step>
