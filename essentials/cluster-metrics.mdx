...
<Note>
The Cluster Metrics page provides real-time visualization of your cluster's resource usage. Connect a Prometheus data source to enable full metrics monitoring.
</Note>
