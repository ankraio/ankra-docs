...
## Build Stacks with AI

The fastest way to create a Stack is with the AI Assistant. Press `⌘+J` to open the chat and describe what you need:
...
<Steps>
  ...
  <Step title="Refine Configuration">
    *"Set retention to 30 days and add PagerDuty integration"* - the AI updates the values.
  </Step>
  <Step title="Deploy">
    Review the Stack in the visual builder and deploy with one click.
  </Step>
</Steps>
...
[Learn more about GitOps →](./cluster-gitops-single)
