...
- **Provision a managed cluster** — let Ankra create a production-ready K3s cluster for you on [Hetzner](/essentials/hetzner-clusters), [OVHcloud](/essentials/ovh-clusters), or [UpCloud](/essentials/upcloud-clusters).
...
<Steps>
  <Step title="Import a Cluster">
    ...
    - Follow the instructions to install the [Ankra Agent](/essentials/cluster-agent) in your cluster.
