...
<Note>
Actions awaiting confirmation, plans awaiting approval, and sessions waiting on your input all surface in your [Activity & Inbox](/essentials/activity-inbox), so long-running agent work doesn't get lost when you navigate away.
</Note>
