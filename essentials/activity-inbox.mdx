...
|------|---------|----------------|
| **AI session awaiting you** | An [AI Assistant](/essentials/ai-assistant) session is paused, waiting for your input | Answer and let it continue |
...
| **Draft with AI edits** | A [stack](/essentials/stacks) draft the AI has edited is waiting for your review | Review and commit |
...
Ankra keeps a list of the [stack](/essentials/stacks) drafts you've worked on recently, so you can jump back into in-progress work. Each entry shows the cluster, stack, when it was last touched, whether it has AI edits, and any co-editors (including the AI) collaborating on it.
