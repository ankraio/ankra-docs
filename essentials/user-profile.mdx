...
Add a second factor to your account with a time-based one-time password (TOTP) from any authenticator app (such as 1Password, Authy, or Google Authenticator). 2FA applies to your account across every organisation you belong to.
...
- **Add or remove** authenticators at any time from **Profile** → **Authentication**.
