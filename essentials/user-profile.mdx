...
The Authentication page lists the identity providers connected to your account (Google, Microsoft, Apple, GitHub) and lets you add an email-and-password login. You can connect or disconnect providers here - for example, link a Microsoft account so you can sign in with your work identity - and at least one sign-in method is always kept.
