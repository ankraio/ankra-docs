...
<Steps>
  ...
  <Step title="Commit">
    Commit the draft to deploy, exactly like any other [stack](/essentials/stacks) change.
  </Step>
</Steps>
...
See [Stacks](/essentials/stacks) for the deploy/commit flow and the [API Reference](/api-reference/introduction) for full schemas.
