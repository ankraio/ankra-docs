...
See [Restarting a Node](/guides/proxmox-clusters#restarting-a-node) and [Resizing the Bastion](/guides/proxmox-clusters#resizing-the-bastion) for usage examples and response shapes. Not yet exposed via `ankra-cli`.
