...
See [Restart a Node](/guides/ovh-clusters#restart-a-node) and [Resizing the Bastion or Gateway](/guides/ovh-clusters#resizing-the-bastion-or-gateway) for usage examples and response shapes.
