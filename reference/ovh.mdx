...
| `gateway_flavor_id` | `b2-7` | Instance flavor for the SSH bastion (the field name predates the bastion rename) |
...
See [Restarting a Node](/guides/ovh-clusters#restarting-a-node) and [Resizing the Bastion or Gateway](/guides/ovh-clusters#resizing-the-bastion-or-gateway) for usage examples and response shapes.
