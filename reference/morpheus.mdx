...
See [Resizing the Bastion](/guides/morpheus-clusters#resizing-the-bastion) for usage examples and response shapes. Not yet exposed via `ankra-cli`. Restarting individual nodes is not yet supported for Morpheus.
