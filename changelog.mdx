...
# OVH Cloud Integration, Command Palette Upgrade, Log Viewer Redesign & CLI v0.1.127

Full OVH Cloud support across the platform, the Command Palette now navigates directly to every Kubernetes resource type, and the Log Viewer is rebuilt for large clusters.
...
New OVH commands for cluster and credential management.
