...
The launch dialog gained a **Component** picker for monorepos, with the container port following your pick. That was the sharpest edge of the old behaviour: a component inherited whichever port appeared first among the repository's generated files, so an api on 8090 could be probed on the frontend's 3000 and the demo sat in *provisioning* until it timed out.
