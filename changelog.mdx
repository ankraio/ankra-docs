...
# UpCloud Integration, OVH Cloud Integration, Command Palette Upgrade, Log Viewer Redesign & CLI v0.1.128

UpCloud and OVH Cloud support across the platform, the Command Palette now navigates directly to every Kubernetes resource type, and the Log Viewer is rebuilt for large clusters.
