...
Ankra now supports time-based one-time password (TOTP) two-factor authentication, so you can protect your account with a second factor from any authenticator app.
