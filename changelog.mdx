...
**CLI v0.1.123 - SOPS Encryption Commands** (Breaking: `ankra cluster sops` removed):
...
**CLI v0.1.123**: SSO authentication, AI-powered chat (`ankra chat`), Helm chart browsing (`ankra charts`), credentials management, stack management, cluster cloning, API token management, and 35+ commands across the platform.
