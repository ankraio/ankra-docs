...
<Update label="2026-09-07" tags={["Cost"]} rss={{ title: "Playground pricing is now documented on the billing page and the Playground page" }}>

## Playground pricing is now documented on the billing page and the Playground page

Every size is listed with its price and what it includes: Trial free, Small €13.50, Medium €28.80, Large €72.00 and Extra large €144.00 a month, from 1 vCPU / 2 GB to 16 vCPU / 32 GB, storage bundled, pods and PVCs capped. The billing page carries the rules: pro-rata by the second, the ordered price as the price of record, nothing metered on top, an 8 GB organisation memory budget.
