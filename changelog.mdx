...
# OVH Cloud Integration, Command Palette Upgrade & CLI v0.1.126

Full OVH Cloud support across the platform, plus the Command Palette now navigates directly to every Kubernetes resource type.
