...
# A Nodes Section for Every Cluster, a Playground for Every Organisation, a New Default AI Model, Microsoft Teams at Slack Parity, Monorepo Demos, Add-on Publishing, Cluster Audit Trails, Power Schedules, Kubernetes Debugging From the CLI, and the Largest CLI Release Yet
